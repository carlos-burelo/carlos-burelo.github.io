! function(a, b) {
	...
	if (!d.TweenLite) {
		var e, f, g, h, i, j = function(a) {
			...
			p = {},
			q = function(e, f, g, h) {
				this.sc = p[e] ? p[e].sc : [], (p[e] = this).gsClass = null, this.func = g;
				var i = [];
				this.check = function(k) {
					for (var l, m, n, o, r, s = f.length, t = s; - 1 < --s;)(l = p[f[s]] || new q(f[s], [])).gsClass ? (i[s] = l.gsClass, t--) : k && l.sc.push(this);
					if (0 === t && g) {
		...
		var t = [0, 0, 1, 1],
			...
			w = u.register = function(a, b, c, d) {
				for (var e, f, g, h, i = b.split(","), j = i.length, l = (c || "easeIn,easeOut,easeInOut").split(","); - 1 < --j;)
					for (f = i[j], e = d ? s("easing." + f, null, !0) : k.easing[f] || {}, g = l.length; - 1 < --g;) h = l[g], v[f + "." + h] = v[h + f] = e[h] = a.getRatio ? a : a[h] || new a
			};
		for ((g = u.prototype)._calcEnd = !1, g.getRatio = function(a) {
			...
			}, f = (e = ["Linear", "Quad", "Cubic", "Quart", "Quint,Strong"]).length; - 1 < --f;) g = e[f] + ",Power" + f, w(new u(null, null, 1, f), g, "easeOut", !0), w(new u(null, null, 2, f), g, "easeIn" + (0 === f ? ",easeNone" : "")), w(new u(null, null, 3, f), g, "easeInOut");
		...
		(g = x.prototype).addEventListener = function(a, b, c, d, e) {
			...
			var f, g, j = this._listeners[a],
				k = 0;
			for (this !== h || i || h.wake(), null == j && (this._listeners[a] = j = []), g = j.length; - 1 < --g;)(f = j[g]).c === b && f.s === c ? j.splice(g, 1) : 0 === k && f.pr < e && (k = g + 1);
			j.splice(k, 0, {
				c: b,
				s: c,
				up: d,
		...
		var y = a.requestAnimationFrame,
			...
			B = A();
		for (f = (e = ["ms", "moz", "webkit", "o"]).length; - 1 < --f && !y;) y = a[e[f] + "RequestAnimationFrame"], z = a[e[f] + "CancelAnimationFrame"] || a[e[f] + "CancelRequestAnimationFrame"];
		s("Ticker", function(a, b) {
			var c, d, e, f, g, j = this,
				...
				r = function(a) {
					var b, h, i = A() - B;
					o < i && (k += i - p), B += i, j.time = (B - k) / 1e3, b = j.time - g, (!c || 0 < b || !0 === a) && (j.frame++, g += b + (f <= b ? .004 : f - b), h = !0), !0 !== a && (e = d(r)), h && j.dispatchEvent("tick")
				};
			x.call(j), j.time = j.frame = 0, j.tick = function() {
				...
				null !== e ? j.sleep() : a ? k += -B + (B = A()) : 10 < j.frame && (B = A() - o + 5), d = 0 === c ? n : m && y ? y : function(a) {
		...
		var D = function() {
			i && 2e3 < A() - B && h.wake(), setTimeout(D, 2e3)
		};
		...
		var F = s("TweenLite", function(b, c, d) {
				...
				else this._propLookup = {}, this._siblings = Y(b, this, !1), 1 === i && 1 < this._siblings.length && $(b, this, null, 1, this._siblings);
		...
		(g = F.prototype = new C).constructor = F, g.kill()._gc = !1, g.ratio = 0, g._firstPT = g._targets = g._overwrittenProps = g._startAt = null, g._notifyPluginsOfEnabled = g._lazy = !1, F.version = "1.19.0", F.defaultEase = g._ease = new u(null, null, 1, 1), F.defaultOverwrite = "auto", F.ticker = h, F.autoSleep = 120, F.lagSmoothing = function(a, b) {
			...
			var c = a.$ || a.jQuery;
			return c ? (F.selector = c)(b) : "undefined" == typeof document ? b : document.querySelectorAll ? document.querySelectorAll(b) : document.getElementById("#" === b.charAt(0) ? b.substr(1) : b)
		};
		var I = [],
			J = {},
			K = /(?:(-|-=|\+=)?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/gi,
			L = function(a) {
				for (var b, c = this._firstPT; c;) b = c.blob ? a ? this.join("") : this.start : c.c * a + c.s, c.m ? b = c.m(b, this._target || c.t) : b < 1e-6 && -1e-6 < b && (b = 0), c.f ? c.fp ? c.t[c.p](c.fp, b) : c.t[c.p](b) : c.t[c.p] = b, c = c._next
			},
			M = function(a, b, c, d) {
				var e, f, g, h, i, j, k, l = [a, b],
					...
					n = "",
					o = 0;
				for (l.start = a, c && (c(l), a = l[0], b = l[1]), l.length = 0, e = a.match(K) || [], f = b.match(K) || [], d && (d._next = null, d.blob = 1, l._firstPT = l._applyPT = d), i = f.length, h = 0; h < i; h++) k = f[h], n += (j = b.substr(m, b.indexOf(k, m) - m)) || !h ? j : ",", m += j.length, o ? o = (o + 1) % 5 : "rgba(" === j.substr(-5) && (o = 1), k === e[h] || e.length <= h ? n += k : (n && (l.push(n), n = ""), g = parseFloat(e[h]), l.push(g), l._firstPT = {
					_next: l._firstPT,
					t: l,
					p: l.length - 1,
					s: g,
			...
			N = function(a, b, c, d, e, f, g, h, i) {
				...
				return "number" != m && ("function" == m && "get" === c && (k = b.indexOf("set") || "function" != typeof a["get" + b.substr(3)] ? b : "get" + b.substr(3), o.s = l = g ? a[k](g) : a[k]()), "string" == typeof l && (g || isNaN(l)) ? (o.fp = g, o = {
					...
					pr: 0,
					m: 0
				}) : n || (o.s = parseFloat(l), o.c = parseFloat(d) - o.s || 0)), o.c ? ((o._next = this._firstPT) && (o._next._prev = o), this._firstPT = o) : void 0
			},
			O = F._internals = {
				isArray: o,
				isSelector: G,
			...
			X = O.lazyRender = function() {
				var a, b = I.length;
				for (J = {}; - 1 < --b;)(a = I[b]) && !1 !== a._lazy && (a.render(a._lazy[0], a._lazy[1], !0), a._lazy = !1);
				I.length = 0
			};
		...
		var Y = function(a, b, c) {
			...
			$ = function(a, b, c, d, e) {
				...
				var j, k = b._startTime + l,
					...
					n = 0,
					o = 0 === b._duration;
				for (f = e.length; - 1 < --f;)(h = e[f]) === b || h._gc || h._paused || (h._timeline !== b._timeline ? (j = j || _(b, 0, o), 0 === _(h, j, o) && (m[n++] = h)) : h._startTime <= k && h._startTime + h.totalDuration() / h._timeScale > k && ((o || !h._initted) && k - h._startTime <= 2e-10 || (m[n++] = h)));
				for (f = n; - 1 < --f;)
			...
			_ = function(a, b, c) {
				...
				return b < (f /= e) ? f - b : c && f === b || !a._initted && f - b < 2 * l ? l : (f += a.totalDuration() / a._timeScale / e) > b + l ? 0 : f - b - l
			};
		g._init = function() {
			...
			return e && this._kill(e, b) ? this._initProps(b, c, d, e, f) : 1 < this._overwrite && this._firstPT && 1 < d.length && $(b, this, c, this._overwrite, d) ? (this._kill(c, b), this._initProps(b, c, d, e, f)) : (this._firstPT && (!1 !== this.vars.lazy && this._duration || this.vars.lazy && !this._duration) && (J[b._gsTweenID] = !0), i)
		}, g.render = function(a, b, c) {
			var d, e, f, g, h = this._time,
				i = this._duration,
				j = this._rawPrevTime;
			if (i - 1e-7 <= a) this._totalTime = this._time = i, this.ratio = this._ease._calcEnd ? this._ease.getRatio(1) : 1, this._reversed || (d = !0, e = "onComplete", c = c || this._timeline.autoRemoveChildren), 0 !== i || !this._initted && this.vars.lazy && !c || (this._startTime === this._timeline._duration && (a = 0), (j < 0 || a <= 0 && -1e-7 <= a || j === l && "isPause" !== this.data) && j !== a && (c = !0, l < j && (e = "onReverseComplete")), this._rawPrevTime = g = !b || a || j === a ? a : l);
			else if (a < 1e-7) this._totalTime = this._time = 0, this.ratio = this._ease._calcEnd ? this._ease.getRatio(0) : 0, (0 !== h || 0 === i && 0 < j) && (e = "onReverseComplete", d = this._reversed), a < 0 && (this._active = !1, 0 !== i || !this._initted && this.vars.lazy && !c || (0 <= j && (j !== l || "isPause" !== this.data) && (c = !0), this._rawPrevTime = g = !b || a || j === a ? a : l)), this._initted || (c = !0);
			else if (this._totalTime = this._time = a, this._easeType) {
				var k = a / i,
					m = this._easeType,
					n = this._easePower;
				(1 === m || 3 === m && .5 <= k) && (k = 1 - k), 3 === m && (k *= 2), 1 === n ? k *= k : 2 === n ? k *= k * k : 3 === n ? k *= k * k * k : 4 === n && (k *= k * k * k * k), this.ratio = 1 === m ? 1 - k : 2 === m ? k : a / i < .5 ? k / 2 : 1 - k / 2
			...
			if (this._time !== h || c) {
				...
				for (!1 !== this._lazy && (this._lazy = !1), this._active || !this._paused && this._time !== h && 0 <= a && (this._active = !0), 0 === h && (this._startAt && (0 <= a ? this._startAt.render(a, b, c) : e = e || "_dummyGS"), !this.vars.onStart || 0 === this._time && 0 !== i || (b || this._callback("onStart"))), f = this._firstPT; f;) f.f ? f.t[f.p](f.c * this.ratio + f.s) : f.t[f.p] = f.c * this.ratio + f.s, f = f._next;
			...
			if (i || h.wake(), a && this._gc) {
				...
				if (d)
					for (c = d.length; - 1 < --c;) this._siblings[c] = Y(d[c], this, !0);
			...
			if (a = "string" != typeof a ? a : F.selector(a) || a, (o(a) || G(a)) && "number" != typeof a[0]) {
				for (c = a.length, d = []; - 1 < --c;) d = d.concat(F.getTweensOf(a[c], b));
				for (c = d.length; - 1 < --c;)
					for (f = d[c], e = c; - 1 < --e;) f === d[e] && d.splice(c, 1)
			} else
				for (c = (d = Y(a).concat()).length; - 1 < --c;)(d[c]._gc || b && !d[c].isActive()) && d.splice(c, 1);
			return d
		}, F.killTweensOf = F.killDelayedCallsTo = function(a, b, c) {
			"object" == typeof b && (c = b, b = !1);
			for (var d = F.getTweensOf(a, b), e = d.length; - 1 < --e;) d[e]._kill(c, a)
		};
		...
		if (g = aa.prototype, aa.version = "1.19.0", aa.API = 2, g._firstPT = null, g._addTween = N, g.setRatio = L, g._kill = function(a) {
				...
				for (var b = a.length; - 1 < --b;) a[b].API === aa.API && (P[(new a[b])._propName] = a[b]);
				return !0
			}, r.plugin = function(a) {
		...
		var a = document.documentElement,
			...
			h = _gsScope._gsDefine.plugin({
				...
				set: function(a) {
					...
					this.x < 0 && (this.x = 0), this.y < 0 && (this.y = 0), this._autoKill && (!this.skipX && (i < g || g < -i) && d < c(this._target, "x") && (this.skipX = !0), !this.skipY && (i < f || f < -i) && e < c(this._target, "y") && (this.skipY = !0), this.skipX && this.skipY && (this._tween.kill(), this.vars.onAutoKill && this.vars.onAutoKill.apply(this.vars.onAutoKillScope || this._tween, this.vars.onAutoKillParams || []))), this._wdw ? b.scrollTo(this.skipX ? d : this.x, this.skipY ? e : this.y) : (this.skipY || (this._target.scrollTop = this.y), this.skipX || (this._target.scrollLeft = this.x)), this.xPrev = this.x, this.yPrev = this.y
				}
			}),
			i = h.prototype;
	...
	function(t, e) {
		...
		var f = {
			...
			N = function(t) {
				...
				if (this.options.update && this.options.update.call(), 1 !== n) return !0;
				if (0 < this.options.repeat) return isFinite(this.options.repeat) && this.options.repeat--, this.options.yoyo && (this.reversed = !this.reversed, tt.call(this)), this._startTime = this.options.yoyo && !this.reversed ? t + this.options.repeatDelay : t, !0;
			...
			J = {
				boxModel: function(t, e) {
					t in j || (j[t] = function(t, e, n, i, s) {
						t.style[e] = (.99 < s || s < .01 ? (10 * Q(n, i, s) >> 0) / 10 : Q(n, i, s) >> 0) + "px"
					});
					var n = m(e);
			...
			et = function() {
				0 < this.repeat && (this.options.repeat = this.repeat), this.options.yoyo && !0 === this.reversed && (tt.call(this), this.reversed = !1), this.playing = !1, setTimeout(function() {
		...
		ot.linear = function(t) {
			...
			var e, n = .1;
			return 0 === t ? 0 : 1 === t ? 1 : (e = !n || n < 1 ? (n = 1, .1) : .4 * Math.asin(1 / n) / Math.PI * 2, -n * Math.pow(2, 10 * (t -= 1)) * Math.sin((t - e) * Math.PI * 2 / .4))
		}, ot.easingElasticOut = function(t) {
			var e, n = .1;
			return 0 === t ? 0 : 1 === t ? 1 : (e = !n || n < 1 ? (n = 1, .1) : .4 * Math.asin(1 / n) / Math.PI * 2, n * Math.pow(2, -10 * t) * Math.sin((t - e) * Math.PI * 2 / .4) + 1)
		}, ot.easingElasticInOut = function(t) {
			var e, n = .1;
			return 0 === t ? 0 : 1 === t ? 1 : (e = !n || n < 1 ? (n = 1, .1) : .4 * Math.asin(1 / n) / Math.PI * 2, (t *= 2) < 1 ? n * Math.pow(2, 10 * (t -= 1)) * Math.sin((t - e) * Math.PI * 2 / .4) * -.5 : n * Math.pow(2, -10 * (t -= 1)) * Math.sin((t - e) * Math.PI * 2 / .4) * .5 + 1)
		...
		function ht(t, e, n, i) {
			this.tweens = [];
			for (var s = [], r = 0, a = t.length; r < a; r++) s[r] = i || {}, i.delay = i.delay || f.delay, s[r].delay = 0 < r ? i.delay + (i.offset || f.offset) : i.delay, this.tweens.push(pt(t[r], e, n, s[r]))
		}
		var lt = (ut.prototype = {
				start: function(t) {
					for (var s in function() {
							...
							}.call(this), this.options.rpr && at.apply(this),
							function() {
								var t = this.element,
									e = this.options;
							...
							}.apply(this), this.valuesEnd) s in G && this.options.rpr && G[s].call(this), this.valuesRepeat[s] = this.valuesStart[s];
				...
				this.tweens = [];
				for (var i = [], s = 0, r = t.length; s < r; s++) i[s] = n || {}, n.delay = n.delay || f.delay, i[s].delay = 0 < s ? n.delay + (n.offset || f.offset) : n.delay, this.tweens.push(ct(t[s], e, i[s]))
			}),
				...
				M = function(t, e) {
					...
					if (this._isPolygon)
						if (t = d(t), e = d(e), t.length !== e.length) {
							o = (i = Math.max(t.length, e.length)) === e.length ? (s = t, e) : (s = e, t), s.length, u = (l = b("M" + s.join("L") + "z")).getTotalLength() / i;
					...
					this.options.reverseFirstPath && r.reverse(), this.options.reverseSecondPath && n.reverse(), c && (n = n.splice(c, i - c).concat(n));
					return t = e = null, [r, n]
				};
...
var ScrollReveal = function() {
	...
	function $(e) {
		...
		return M = t, document.documentElement.classList.add("sr"), document.body ? document.body.style.height = "100%" : document.addEventListener("DOMContentLoaded", function() {
			...
			history: [],
			sequences: {}
		}, this.pristine = !0, R = R || function(e, t) {
			var i = this;
			void 0 === e && (e = {
				type: "init"
	...
	var o = {
			...
			updateProgress: function(e) {
				...
				var t = this,
					...
					o = r,
					l = n;
				n = 0 == i ? r = !(s = 0) : (r = (s = (e - t.minTranslate()) / i) <= 0, 1 <= s), X.extend(t, {
					progress: s,
					isBeginning: r,
					isEnd: n
	...
	var w, b = {
		...
		S = function(u) {
			function h() {
				...
				s = (s = 1 === a.length && a[0].constructor && a[0].constructor === Object ? a[0] : (t = (e = a)[0], e[1])) || {}, s = X.extend({}, s), t && !s.el && (s.el = t), u.call(this, s), Object.keys(E).forEach(function(t) {
		...
		D = {
			update: function(e) {
				...
				h = t.rtlTranslate ? "right" : t.isHorizontal() ? "left" : "top", f = r ? (v = Math.floor(i / 2) + s, Math.floor(i / 2) + s) : (v = i + (s - 1), s);
...
function(e, t) {
	...
	function l(argument_0) {
		var e, t = 0 < arguments.length && void 0 !== argument_0 ? argument_0 : {},
			n = t.id,
			r = t.url,
			o = n || r;
	...
	function p(r, argument_1) {
		var e = 1 < arguments.length && void 0 !== argument_1 ? argument_1 : {};
	...
	function m(i, argument_1, argument_2) {
		var a = 1 < arguments.length && void 0 !== argument_1 ? argument_1 : {},
			u = 2 < arguments.length ? argument_2 : void 0;
	...
	var k = new WeakMap,
		...
		Player = function() {
			function Player(u) {
				...
				if (function(e) {
						if (!(e instanceof Player)) throw new TypeError("Cannot call a class as a function")
					}(this), window.jQuery && u instanceof jQuery && (1 < u.length && window.console && console.warn && console.warn("Hello"), u = u[0]), "undefined" != typeof document && "string" == typeof u && (u = document.getElementById(u)), e = u, !Boolean(e && 1 === e.nodeType && "nodeName" in e && e.ownerDocument && e.ownerDocument.defaultView)) throw new TypeError("You must pass either a valid element or a valid id.");
				var r = u.ownerDocument.defaultView;
				if ("IFRAME" !== u.nodeName) {
					var t = u.querySelector("iframe");
					t && (u = t)
				}
				if ("IFRAME" === u.nodeName && !s(u.getAttribute("src") || "")) throw new Error("Hello x2");
				...
				var o = new f(function(i, a) {
					...
					if (r.addEventListener ? r.addEventListener("message", e, !1) : r.attachEvent && r.attachEvent("onmessage", e), "IFRAME" !== c.element.nodeName) {
						...
						m(l(t), t, u).then(function(e) {
							var t, n, r, o = y(e, u);
							return c.element = o, t = c._originalElement = u, n = o, r = d.get(t), d.set(n, r), d.delete(t), k.set(c.element, c), e
						}).catch(a)
					}
				});
			...
			}], r(Player.prototype, t), Player
		}();
	return e || (function(argument_0) {
		function n(e) {
			"console" in window && console.error && console.error("There was an error creating an embed: ".concat(e))
		}
		var e = 0 < arguments.length && void 0 !== argument_0 ? argument_0 : document,
		...
		var r = 0 < arguments.length && void 0 !== argument_0 ? argument_0 : document;
...
var ZuckJS = window.ZuckitaDaGalera = window.Zuck = function(timeline, options) {
	var d = document,
		zuck = this;
	"string" == typeof timeline && (timeline = d.getElementById(timeline));
	var query = function(_query) {
			return d.querySelectorAll(_query)[0]
		},
		get = function(array, what) {
			return array && array[what] || ""
		},
		each = function(arr, func) {
			if (arr)
				for (var total = arr.length, i = 0; i < total; i++) func(i, arr[i])
		},
		...
		addVendorEvents = function(el, func, event) {
			...
			each(events, function(i, val) {
				el.addEventListener(val, func, !1)
			})
		},
		...
		fullScreen = function(elem, cancel) {
			...
			if (cancel) document.exitFullscreen ? document.exitFullscreen() : document.mozCancelFullScreen ? document.mozCancelFullScreen() : document.webkitExitFullscreen && document.webkitExitFullscreen();
			else try {
				elem.requestFullScreen ? elem.requestFullScreen() : elem["ms" + func] ? elem["ms" + func]() : elem["moz" + func] ? elem["moz" + func]() : elem["webkit" + func] && elem["webkit" + func]()
			} catch (e) {}
		},
		translate = function(element, to, duration, ease) {
			var direction = 0 < to ? 1 : -1,
				to3d = Math.abs(to) / query("#zuck-modal").offsetWidth * 90 * direction;
			if (option("cubeEffect")) {
				var scaling = 0 == to3d ? "scale(0.95)" : "scale(0.930,0.930)";
				if (setVendorVariable(query("#zuck-modal-content").style, "Transform", scaling), to3d < -90 || 90 < to3d) return !1
			}
			var transform = option("cubeEffect") ? "rotateY(" + to3d + "deg)" : "translate3d(" + to + "px, 0, 0)";
			element && (setVendorVariable(element.style, "TransitionTimingFunction", ease), setVendorVariable(element.style, "TransitionDuration", duration + "ms"), setVendorVariable(element.style, "Transform", transform))
		},
		findPos = function(obj, offsetY, offsetX, stop) {
			...
			if (obj) {
				if (obj.offsetParent)
					do {
						if (curleft += obj.offsetLeft, curtop += obj.offsetTop, obj == stop) break
					} while (obj = obj.offsetParent);
				offsetY && (curtop -= offsetY), offsetX && (curleft -= offsetX)
			}
			return [curleft, curtop]
		},
		timeAgo = function(time) {
			time = 1e3 * Number(time);
			var dateObj = new Date(time),
				dateStr = dateObj.getTime(),
				seconds = ((new Date).getTime() - dateStr) / 1e3,
				language = option("language", "time"),
				formats = [
				...
				currentFormat = 1;
			seconds < 0 && (seconds = Math.abs(seconds), currentFormat = 2);
			for (var i = 0, format = void 0; format = formats[i++];)
				if (seconds < format[0]) return "string" == typeof format[2] ? format[currentFormat] : Math.floor(seconds / format[2]) + format[1];
		...
		option = function(name, prop) {
			...
			return prop ? type(options[name]) && type(options[name][prop]) ? options[name][prop] : optionsDefault[name][prop] : type(options[name]) ? options[name] : optionsDefault[name]
		},
		modal = new function() {
			var modalContainer = get("#zuck-modal");
			modalContainer || ((modalContainer = d.createElement("div")).id = "zuck-modal", option("cubeEffect") && (modalContainer.className = "with-cube"), modalContainer.innerHTML = '<div id="zuck-modal-content"></div>', modalContainer.style.display = "none", modalContainer.setAttribute("tabIndex", "1"), modalContainer.onkeyup = function(e) {
				var code = e.keyCode;
				27 == code ? modal.close() : 13 != code && 32 != code || modal.next()
			}, option("openEffect") && modalContainer.classList.add("with-effects"), function(el, func) {
				el.transitionEndEvent || (el.transitionEndEvent = !0, addVendorEvents(el, func, "TransitionEnd"))
			}(modalContainer, function() {
				modalContainer.classList.contains("closed") && (modalContent.innerHTML = "", modalContainer.style.display = "none", modalContainer.classList.remove("closed"), modalContainer.classList.remove("animated"))
			}), d.body.appendChild(modalContainer));
			var modalContent = query("#zuck-modal-content"),
				moveStoryItem = function(direction) {
					var target = "",
						useless = "",
						transform = "0",
					...
					if (!slideItems.previous && !direction || !slideItems.next && direction) return !1;
					useless = direction ? (target = "next", "previous") : (target = "previous", "next"), option("cubeEffect") ? "previous" == target ? transform = modalContainer.slideWidth : "next" == target && (transform = -1 * modalContainer.slideWidth) : transform = -1 * (transform = findPos(slideItems[target]))[0], translate(modalSlider, transform, 600, null), setTimeout(function() {
						if ("" != target && slideItems[target] && "" != useless) {
							var currentStory = slideItems[target].getAttribute("data-story-id");
							zuck.internalData.currentStory = currentStory;
							var oldStory = query("#zuck-modal .story-viewer." + useless);
							oldStory && oldStory.parentNode.removeChild(oldStory), slideItems.viewing && (slideItems.viewing.classList.add("stopped"), slideItems.viewing.classList.add(useless), slideItems.viewing.classList.remove("viewing")), slideItems[target] && (slideItems[target].classList.remove("stopped"), slideItems[target].classList.remove(target), slideItems[target].classList.add("viewing"));
							var newStoryData = getStoryMorningGlory(target);
							newStoryData && createStoryViewer(newStoryData, target);
							var storyId = zuck.internalData.currentStory,
								items = query('#zuck-modal [data-story-id="' + storyId + '"]');
							if (items) {
								var duration = (items = items.querySelectorAll("[data-index].active"))[0].firstElementChild;
								zuck.data[storyId].currentItem = parseInt(items[0].getAttribute("data-index"), 10), items[0].innerHTML = '<b style="' + duration.style.cssText + '"></b>', onAnimationEnd(items[0].firstElementChild, function() {
									zuck.nextItem(!1)
								})
							}
							translate(modalSlider, "0", 0, null), items && playVideoItem([items[0], items[1]], !0), option("callbacks", "onView")(zuck.internalData.currentStory)
						}
					}, 650)
				},
				createStoryViewer = function(storyData, className, forcePlay) {
					var modalSlider = query("#zuck-modal-slider-" + id),
						htmlItems = "",
						pointerItems = "",
						storyId = get(storyData, "id"),
						slides = d.createElement("div"),
						currentItem = get(storyData, "currentItem") || 0,
						exists = query('#zuck-modal .story-viewer[data-story-id="' + storyId + '"]'),
						currentItemTime = "";
					if (exists) return !1;
					slides.className = "slides", each(get(storyData, "items"), function(i, item) {
						i < currentItem && (storyData.items[i].seen = !0, item.seen = !0);
						var length = get(item, "length"),
							linkText = get(item, "linkText"),
							seenClass = !0 === get(item, "seen") ? "seen" : "",
							commonAttrs = 'data-index="' + i + '" data-item-id="' + get(item, "id") + '"';
						currentItem === i && (currentItemTime = timeAgo(get(item, "time"))), pointerItems += "<span " + commonAttrs + ' class="' + (currentItem === i ? "active" : "") + " " + seenClass + '"><b style="animation-duration:' + ("" === length ? "3" : length) + 's"></b></span>', htmlItems += '<div data-time="' + get(item, "time") + '" data-type="' + get(item, "type") + '"' + commonAttrs + ' class="item ' + seenClass + " " + (currentItem === i ? "active" : "") + '">' + ("video" === get(item, "type") ? '<video class="media" muted webkit-playsinline playsinline preload="auto" src="' + get(item, "src") + '" ' + get(item, "type") + '></video><b class="tip muted">' + option("language", "unmute") + "</b>" : '<img class="media" src="' + get(item, "src") + '" ' + get(item, "type") + ">") + (get(item, "link") ? '<a class="tip link" href="' + get(item, "link") + '"  target="_blank">' + ("" != linkText && linkText ? linkText : option("language", "visitLink")) + "</a>" : "") + "</div>"
					}), slides.innerHTML = htmlItems;
					var video = slides.querySelector("video"),
						addMuted = function(video) {
							video.muted ? storyViewer.classList.add("muted") : storyViewer.classList.remove("muted")
						};
					video && (video.onwaiting = function(e) {
						video.paused && (storyViewer.classList.add("paused"), storyViewer.classList.add("loading"))
					}, video.onplay = function() {
						addMuted(video), storyViewer.classList.remove("stopped"), storyViewer.classList.remove("paused"), storyViewer.classList.remove("loading")
					}, video.onready = video.onload = video.onplaying = video.oncanplay = function() {
						addMuted(video), storyViewer.classList.remove("loading")
					}, video.onvolumechange = function() {
						addMuted(video)
					});
					var storyViewer = d.createElement("div");
					storyViewer.className = "story-viewer muted " + className + " " + (forcePlay ? "" : "stopped") + " " + (option("backButton") ? "with-back-button" : ""), storyViewer.setAttribute("data-story-id", storyId);
					var html = '<div class="head"><div class="left">' + (option("backButton") ? '<a class="back">&lsaquo;</a>' : "") + '<u class="img" style="background-image:url(' + get(storyData, "photo") + ');"></u><div><p>' + get(storyData, "name") + '</[strong]><p class="time">' + currentItemTime + '</p></div></div><div class="right"><span class="time">' + currentItemTime + '</span><span class="loading"></span><a class="close" tabIndex="2">&times;</a></div></div><div class="slides-pointers"><div>' + pointerItems + "</div></div>";
					storyViewer.innerHTML = html, each(storyViewer.querySelectorAll(".close, .back"), function(i, el) {
						el.onclick = function(e) {
							e.preventDefault(), modal.close()
						}
					}), storyViewer.appendChild(slides), "viewing" == className && playVideoItem(storyViewer.querySelectorAll('[data-index="' + currentItem + '"].active'), !1), each(storyViewer.querySelectorAll(".slides-pointers [data-index] > b"), function(i, el) {
						onAnimationEnd(el, function() {
							zuck.nextItem(!1)
						})
					}), "previous" == className ? prepend(modalSlider, storyViewer) : modalSlider.appendChild(storyViewer)
				};
			return {
				show: function(storyId, page) {
					option("callbacks", "onOpen")(storyId, function() {
						modalContent.innerHTML = '<div id="zuck-modal-slider-' + id + '" class="slider"></div>';
						var storyData = zuck.data[storyId],
							currentItem = storyData.currentItem || 0;
						! function(modalSliderElement) {
							var modalSlider = modalSliderElement,
								...
								touchStart = function(event) {
									...
									if ("A" == event.target.nodeName) return !0;
									event.preventDefault();
									var touches = event.touches ? event.touches[0] : event,
										pos = findPos(query("#zuck-modal .story-viewer.viewing"));
									modalContainer.slideWidth = query("#zuck-modal .story-viewer").offsetWidth, position = {
										x: pos[0],
										y: pos[1]
									};
									...
									touchOffset = {
										...
										y: pageY,
										time: Date.now()
									}, isScrolling = void 0, delta = {}, modalSlider.addEventListener("mousemove", touchMove), modalSlider.addEventListener("mouseup", touchEnd), modalSlider.addEventListener("mouseleave", touchEnd), modalSlider.addEventListener("touchmove", touchMove), modalSlider.addEventListener("touchend", touchEnd), storyViewer && storyViewer.classList.add("paused"), pauseVideoItem(), timer = setTimeout(function() {
										storyViewer.classList.add("longPress")
									}, 600), nextTimer = setTimeout(function() {
										clearInterval(nextTimer), nextTimer = !1
									}, 250)
								},
								touchMove = function(event) {
									...
									}, void 0 === isScrolling && (isScrolling = !!(isScrolling || Math.abs(delta.x) < Math.abs(delta.y))), !isScrolling && touchOffset && (event.preventDefault(), translate(modalSlider, position.x + delta.x, 0, null)))
								},
								touchEnd = function touchEnd(event) {
									var storyViewer = query("#zuck-modal .viewing"),
										lastTouchOffset = touchOffset;
									if (delta) {
										d.querySelectorAll("#zuck-modal .story-viewer").length;
										var duration = touchOffset ? Date.now() - touchOffset.time : void 0,
											isValid = Number(duration) < 300 && 25 < Math.abs(delta.x) || Math.abs(delta.x) > modalContainer.slideWidth / 3,
											direction = delta.x < 0,
											index = query(direction ? "#zuck-modal .story-viewer.next" : "#zuck-modal .story-viewer.previous");
										isScrolling || (!isValid || direction && !index || !direction && !index ? translate(modalSlider, position.x, 300) : moveStoryItem(direction)), touchOffset = void 0, modalSlider.removeEventListener("mousemove", touchMove), modalSlider.removeEventListener("mouseup", touchEnd), modalSlider.removeEventListener("mouseleave", touchEnd), modalSlider.removeEventListener("touchmove", touchMove), modalSlider.removeEventListener("touchend", touchEnd)
									}
									var video = zuck.internalData.currentVideoElement;
									if (timer && clearInterval(timer), storyViewer && (storyViewer.classList.remove("longPress"), storyViewer.classList.remove("paused")), nextTimer) {
										clearInterval(nextTimer), nextTimer = !1;
										var navigateItem = function() {
												lastTouchOffset.x > window.screen.width / 3 || !option("previousTap") ? zuck.navigateItem("next", event) : zuck.navigateItem("previous", event)
											},
											_storyViewer = query("#zuck-modal .viewing");
										if (!_storyViewer || !video) return navigateItem(), !1;
										_storyViewer.classList.contains("muted") ? unmuteVideoItem(video, _storyViewer) : navigateItem()
									}
								};
							modalSlider.addEventListener("touchstart", touchStart), modalSlider.addEventListener("mousedown", touchStart)
						}(query("#zuck-modal-slider-" + id)), zuck.internalData.currentStory = storyId, storyData.currentItem = currentItem, option("backNative") && (location.hash = "#!" + id);
						var previousItemData = getStoryMorningGlory("previous");
						previousItemData && createStoryViewer(previousItemData, "previous"), createStoryViewer(storyData, "viewing", !0);
						var nextItemData = getStoryMorningGlory("next");
						nextItemData && createStoryViewer(nextItemData, "next"), option("autoFullScreen") && modalContainer.classList.add("fullscreen");
						var tryFullScreen = function() {
							modalContainer.classList.contains("fullscreen") && option("autoFullScreen") && window.screen.width <= 1024 && fullScreen(modalContainer), modalContainer.focus()
						};
						if (option("openEffect")) {
							var storyEl = query("#" + id + ' [data-id="' + storyId + '"] .img'),
								pos = findPos(storyEl);
							modalContainer.style.marginLeft = pos[0] + storyEl.offsetWidth / 2 + "px", modalContainer.style.marginTop = pos[1] + storyEl.offsetHeight / 2 + "px", modalContainer.style.display = "block", modalContainer.slideWidth = query("#zuck-modal .story-viewer").offsetWidth, setTimeout(function() {
								modalContainer.classList.add("animated")
							}, 10), setTimeout(function() {
								tryFullScreen()
							}, 300)
						} else modalContainer.style.display = "block", modalContainer.slideWidth = query("#zuck-modal .story-viewer").offsetWidth, tryFullScreen();
						option("callbacks", "onView")(storyId)
					})
				},
				next: function(unmute) {
					option("callbacks", "onEnd")(zuck.internalData.currentStory, function() {
						var lastStory = zuck.internalData.currentStory,
							lastStoryTimelineElement = query("#" + id + ' [data-id="' + lastStory + '"]');
						lastStoryTimelineElement && (lastStoryTimelineElement.classList.add("seen"), zuck.data[lastStory].seen = !0, zuck.internalData.seenItems[lastStory] = !0, saveLocalData("seenItems", zuck.internalData.seenItems), updateStoryseenPosition()), query("#zuck-modal .story-viewer.next") ? moveStoryItem(!0) : modal.close()
					})
				},
				close: function() {
					option("callbacks", "onClose")(zuck.internalData.currentStory, function() {
						option("backNative") && (location.hash = ""), fullScreen(modalContainer, !0), option("openEffect") ? modalContainer.classList.add("closed") : (modalContent.innerHTML = "", modalContainer.style.display = "none")
					})
				}
			}
		},
		parseStory = function(story) {
			var storyId = story.getAttribute("data-id"),
				seen = !1;
			zuck.internalData.seenItems[storyId] && (seen = !0), seen ? story.classList.add("seen") : story.classList.remove("seen");
			try {
				zuck.data[storyId] = {
					id: storyId,
		...
		updateStoryseenPosition = function() {
			each(d.querySelectorAll("#" + id + " .story.seen"), function(i, el) {
				...
				el.parentNode.removeChild(el), zuck.add(newData, !0)
			})
		},
		playVideoItem = function(elements, unmute) {
			var itemElement = elements[1],
				itemPointer = elements[0],
				storyViewer = itemPointer.parentNode.parentNode.parentNode;
			if (!itemElement || !itemPointer) return !1;
			var cur = zuck.internalData.currentVideoElement;
			if (cur && cur.pause(), "video" == itemElement.getAttribute("data-type")) {
				var video = itemElement.getElementsByTagName("video")[0];
				if (!video) return zuck.internalData.currentVideoElement = !1;
				var setDuration = function() {
					video.duration && setVendorVariable(itemPointer.getElementsByTagName("b")[0].style, "AnimationDuration", video.duration + "s")
				};
				setDuration(), video.addEventListener("loadedmetadata", setDuration), (zuck.internalData.currentVideoElement = video).currentTime = 0, video.play(), unmute.target && unmuteVideoItem(video, storyViewer)
			} else zuck.internalData.currentVideoElement = !1
		},
		...
		unmuteVideoItem = function(video, storyViewer) {
			video.muted = !1, video.volume = 1, video.removeAttribute("muted"), video.play(), video.paused && (video.muted = !0, video.play()), storyViewer && storyViewer.classList.remove("paused")
		},
	...
	return zuck.data = {}, zuck.internalData = {}, zuck.internalData.seenItems = function(key) {
			if (option("localStorage")) {
				var keyName = "zuck-" + id + "-" + key;
				return !!window.localStorage[keyName] && JSON.parse(window.localStorage[keyName])
			}
			return !1
		}("seenItems") || {}, zuck.add = zuck.update = function(data, append) {
			var html, storyId = get(data, "id"),
				storyEl = query("#" + id + ' [data-id="' + storyId + '"]'),
				items = get(data, "items"),
				story = !1;
			zuck.data[storyId] = {}, storyEl ? story = storyEl : (story = d.createElement("div")).className = "story", !1 === data.seen && (zuck.internalData.seenItems[storyId] = !1, saveLocalData("seenItems", zuck.internalData.seenItems)), story.setAttribute("data-id", storyId), story.setAttribute("data-photo", get(data, "photo")), story.setAttribute("data-last-updated", get(data, "lastUpdated"));
			var preview = !1;
			items[0] && (preview = items[0].preview || ""), html = '<a href="' + get(data, "link") + '"><span class="img"><u style="background-image:url(' + (option("avatars") || !preview || "" == preview ? get(data, "photo") : preview) + ')"></u></span><span class="info"><p>' + get(data, "name") + '</p><p class="">' + get(data, "lastUpdated") + '</p></span></a><ul class="items"></ul>', story.innerHTML = html, parseStory(story), storyEl || (append ? timeline.appendChild(story) : prepend(timeline, story)), each(items, function(i, item) {
				zuck.addItem(storyId, item, append)
			}), append || updateStoryseenPosition()
		}, zuck.next = function() {
			modal.next()
		}, zuck.addItem = function(storyId, data, append) {
			var story = query("#" + id + ' > [data-id="' + storyId + '"]'),
				li = d.createElement("li");
			li.className = get(data, "seen") ? "seen" : "", li.setAttribute("data-id", get(data, "id")), li.innerHTML = '<a href="' + get(data, "src") + '" data-link="' + get(data, "link") + '" data-linkText="' + get(data, "linkText") + '" data-time="' + get(data, "time") + '" data-type="' + get(data, "type") + '" data-length="' + get(data, "length") + '"><img src="' + get(data, "preview") + '"></a>';
			var el = story.querySelectorAll(".items")[0];
			append ? el.appendChild(li) : prepend(el, li),
				function(story) {
					var storyId = story.getAttribute("data-id"),
						storyItems = d.querySelectorAll("#" + id + ' [data-id="' + storyId + '"] .items > li'),
						items = [];
			...
			var currentStory = zuck.internalData.currentStory,
				currentItem = zuck.data[currentStory].currentItem,
				storyViewer = query('#zuck-modal .story-viewer[data-story-id="' + currentStory + '"]'),
				directionNumber = "previous" == direction ? -1 : 1;
			if (!storyViewer || 1 == storyViewer.touchMove) return !1;
			var currentItemElements = storyViewer.querySelectorAll('[data-index="' + currentItem + '"]'),
				currentPointer = currentItemElements[0],
				currentItemElement = currentItemElements[1],
				navigateItem = currentItem + directionNumber,
				nextItems = storyViewer.querySelectorAll('[data-index="' + navigateItem + '"]'),
				nextPointer = nextItems[0],
				nextItem = nextItems[1];
			if (storyViewer && nextPointer && nextItem) {
				var callback = option("callbacks", "onNavigateItem");
				(callback = option("callbacks", callback ? "onNavigateItem" : "onNextItem"))(currentStory, nextItem.getAttribute("data-story-id"), function() {
					"previous" == direction ? (currentPointer.classList.remove("seen"), currentItemElement.classList.remove("seen")) : (currentPointer.classList.add("seen"), currentItemElement.classList.add("seen")), currentPointer.classList.remove("active"), currentItemElement.classList.remove("active"), nextPointer.classList.remove("seen"), nextPointer.classList.add("active"), nextItem.classList.remove("seen"), nextItem.classList.add("active"), each(storyViewer.querySelectorAll(".time"), function(i, el) {
						el.innerText = timeAgo(nextItem.getAttribute("data-time"))
					}), zuck.data[currentStory].currentItem = zuck.data[currentStory].currentItem + directionNumber, playVideoItem(nextItems, event)
				})
			} else storyViewer && "previous" != direction && modal.next(event)
		},
		function() {
			location.hash == "#!" + id && (location.hash = ""), query("#" + id + " .story") && each(timeline.querySelectorAll(".story"), function(i, story) {
				parseStory(story)
			}), option("backNative") && window.addEventListener("popstate", function(e) {
				location.hash != "#!" + id && (location.hash = "")
			}, !1), each(option("stories"), function(i, item) {
				zuck.add(item, !0)
			}), updateStoryseenPosition();
			var avatars = option("avatars") ? "user-icon" : "story-preview",
				list = option("list") ? "list" : "carousel";
			return timeline.className = "stories " + avatars + " " + list + " " + (option("skin") + "").toLowerCase(), zuck
		}()
};
(function() {
	this.Calendly = {}
	...
	function() {
		Calendly.initInlineWidgets = function() {
			...
			var e, t, n, i, o;
			for (o = [], n = 0, i = (t = document.querySelectorAll(".calendly-inline-widget")).length; n < i; n++)(e = t[n]).getAttribute("data-processed") ? o.push(void 0) : (e.setAttribute("data-processed", !0), o.push(new Calendly.Iframe(e, !0, "Inline")));
			return o
	...
	function() {
		...
		Calendly.Iframe = (e.prototype.isMobile = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent), e.prototype.build = function() {
	...
	function() {
		...
		Calendly.PopupWidget = (t.prototype.show = function() {
	...
	function() {
		...
		Calendly.BadgeWidget = (e.prototype.destroy = function() {
...
var hasStickyNav = null !== document.querySelector(".sales__navigation");
...
function clickHandler(e) {
	if (location.pathname.replace(/^\//, "") == this.pathname.replace(/^\//, "") && location.hostname == this.hostname) {
		...
		if (target) {
			var bodyRect = document.body.getBoundingClientRect(),
				offsetTop = target.getBoundingClientRect().top - bodyRect.top,
				extraOffset = hasStickyNav ? 120 : 60;
			return TweenLite.to(window, 1, {
				scrollTo: {
					y: offsetTop - extraOffset,
					autoKill: !1
				},
	...
	if (anchors && anchors.length)
		for (var i = 0; i < anchors.length; i++) anchors[i].addEventListener("click", clickHandler, !1)
}();
...
var consoleCss = "font-size: 13px; padding: 85px 0 20px; background: url(https://carlos-burelo.github.io/Website/fav/web-icon.png) no-repeat; background-size: auto 50px; background-position: 0 15px";
console.log("%cCarlos Burelo", consoleCss);
var navIsOpen = !1,
...
for (var swiperTitle = document.getElementsByClassName("tab-title"), stepsPrev = document.getElementById("steps--prev"), stepsNext = document.getElementById("steps--next"), steps = document.getElementsByClassName("slider--steps")[0], tabs = [], i = 0; i < swiperTitle.length; i++) {
	var title = swiperTitle[i].innerHTML;
	tabs.push(title)
}
var sliderTabs = new Swiper(".slider--tabs", {
		...
		pagination: {
			...
			renderBullet: function(index, className) {
				return '<div class="' + className + '"> <p class="title">' + tabs[index] + '<span class="bullet--blue"></span></p></div>'
			}
		}
	}),
...
function delaySalesAnimation() {
	document.getElementById("sales-animation").classList.add("sales--animate")
}
if (window.onload = function() {
	...
	}, ScrollReveal().reveal(".sales-animation", {
		duration: 0,
		delay: 0,
		interval: 0,
		reset: !1,
		scale: 1,
		afterReveal: delaySalesAnimation
	}), null !== document.querySelector(".sales__navigation")) {
	var nav = document.getElementsByClassName("sales__navigation")[0],
		navPositionY = nav.getBoundingClientRect().top,
		offsetTop = window.pageYOffset + navPositionY;
	window.addEventListener("scroll", function() {
			var scrollPosition = window.pageYOffset;
			offsetTop < scrollPosition ? nav.classList.add("navigation--fixed") : nav.classList.remove("navigation--fixed")
		}),
		function() {
			"use strict";
			var section = document.querySelectorAll(".sales__section"),
				sections = {},
				i = 0;
			Array.prototype.forEach.call(section, function(e) {
				...
				for (i in sections) sections[i] <= scrollPosition && (document.querySelector(".link.active") && document.querySelector(".link.active").classList.remove("active"), document.querySelector("a.link[href*=" + i + "]").classList.add("active"));
				scrollPosition < offsetTop && document.querySelector(".link.active") && document.querySelector(".link.active").classList.remove("active"), scrollPosition >= document.body.scrollHeight - window.innerHeight - 50 && (document.querySelector(".link.active") && document.querySelector(".link.active").classList.remove("active"), document.querySelector("a.link[href*=contact]").classList.add("active"))
			}
		}()
}
...
breakpoint.addListener(breakpointChecker), breakpointChecker(), null !== document.querySelector(".globe__website__image") && ScrollReveal().reveal(".globe__website__image", {
	duration: 500,
	delay: 200,
	interval: 200,
	reset: !1,
...
var getOffsetTop = function(elem) {
	...
	caseParallax = function(elem, speed, direction) {
		for (var scrolled = window.pageYOffset, windowHeight = window.innerHeight, i = 0; i < elem.length; i++) {
			...
			if (originalOffsetTop - windowHeight < scrolled && scrolled < originalOffsetTop + cardHeight) {
...
var tweenOpen, tweenClose, lastPosition = -1;
...
frameLoop();
var prevVideo = document.getElementById("preview-video"),
	fullVideo = document.getElementById("full-video");
if (prevVideo && fullVideo) {
	tweenOpen = KUTE.to("#path-x-shape", {
		svgTransform: {
			scale: 27,
			translate: [600, 120]
		}
		...
		duration: 2e3
	}), tweenClose = KUTE.to("#path-x-shape", {
		svgTransform: {
			scale: .75,
			translate: [1117.5, 59]
		}
	...
	var openVideo = function() {
			tweenOpen.start(), document.body.className = "video-open", fullVideo.play(), prevVideo.pause()
		},
		closeVideo = function() {
			tweenClose.start(), document.body.className = "video-closed", prevVideo.play(), fullVideo.pause(), parallaxScroll()
		};
	fullVideo.onended = function() {
		closeVideo()
	}
}
document.body.className = "", updateParallax();
var sliderServices = new Swiper(".slider--services", {
		speed: 500,
		slidesPerView: "auto"
	}),
	iframe = document.getElementById("showreel"),
	player = new Vimeo.Player(iframe),
	playerContainer = document.getElementsByClassName("showreel-container")[0],
	play = document.getElementsByClassName("play-showreel"),
	stop = document.getElementsByClassName("close-showreel")[0];
player.ready().then(function() {
	function close() {
		playerContainer.classList.remove("open"), player.pause(), setTimeout(function() {
			player.setCurrentTime(0)
		}, 300)
	}
	for (i = 0; i < play.length; i++) play[i].addEventListener("click", function(e) {
		playerContainer.classList.add("open"), player.play()
	});
	stop.addEventListener("click", function(e) {
		...
		("key" in (e = e || window.event) ? "Escape" === e.key || "Esc" === e.key : 27 === e.keyCode) && close()
	}
});