	...
	if ( !d.TweenLite ) {
		var e, f, g, h, i, j = function( a ) {
			...
			q = function( e, f, g, h ) {
				...
				this.check = function( k ) {
					...
					if ( 0 === t && g ) {
						if ( n = ( m = ( "com.greensock." + e )
								.split( "." ) )
							.pop(), o = j( m.join( "." ) )[ n ] = this.gsClass = g.apply( g, i ), h )
							if ( d[ n ] = c[ n ] = o, !( r = "undefined" != typeof module && module.exports ) && "function" == typeof define && define.amd ) define( ( a.GreenSockAMDPath ? a.GreenSockAMDPath + "/" : "" ) + e.split( "." )
								.pop(), [], ( function() {
									return o
								} ) );
							else if ( r )
		...
		var t = [ 0, 0, 1, 1 ],
			...
			w = u.register = function( a, b, c, d ) {
				for ( var e, f, g, h, i = b.split( "," ), j = i.length, l = ( c || "easeIn,easeOut,easeInOut" )
						.split( "," ); --j > -1; )
					for ( f = i[ j ], e = d ? s( "easing." + f, null, !0 ) : k.easing[ f ] || {}, g = l.length; --g > -1; ) h = l[ g ], v[ f + "." + h ] = v[ h + f ] = e[ h ] = a.getRatio ? a : a[ h ] || new a
			};
		for ( ( g = u.prototype )
			._calcEnd = !1, g.getRatio = function( a ) {
				if ( this._func ) return this._params[ 0 ] = a, this._func.apply( null, this._params );
				var b = this._type,
					c = this._power,
					d = 1 === b ? 1 - a : 2 === b ? a : .5 > a ? 2 * a : 2 * ( 1 - a );
				return 1 === c ? d *= d : 2 === c ? d *= d * d : 3 === c ? d *= d * d * d : 4 === c && ( d *= d * d * d * d ), 1 === b ? 1 - d : 2 === b ? d : .5 > a ? d / 2 : 1 - d / 2
			}, f = ( e = [ "Linear", "Quad", "Cubic", "Quart", "Quint,Strong" ] )
			.length; --f > -1; ) g = e[ f ] + ",Power" + f, w( new u( null, null, 1, f ), g, "easeOut", !0 ), w( new u( null, null, 2, f ), g, "easeIn" + ( 0 === f ? ",easeNone" : "" ) ), w( new u( null, null, 3, f ), g, "easeInOut" );
		...
		.addEventListener = function( a, b, c, d, e ) {
			...
			for ( this !== h || i || h.wake(), null == j && ( this._listeners[ a ] = j = [] ), g = j.length; --g > -1; )( f = j[ g ] )
				.c === b && f.s === c ? j.splice( g, 1 ) : 0 === k && f.pr < e && ( k = g + 1 );
			j.splice( k, 0, {
				c: b,
				s: c,
				up: d,
		...
		var y = a.requestAnimationFrame,
			...
			B = A();
		for ( f = ( e = [ "ms", "moz", "webkit", "o" ] )
			.length; --f > -1 && !y; ) y = a[ e[ f ] + "RequestAnimationFrame" ], z = a[ e[ f ] + "CancelAnimationFrame" ] || a[ e[ f ] + "CancelRequestAnimationFrame" ];
		...
		h = C.ticker = new k.Ticker, ( g = C.prototype )
			._dirty = g._gc = g._initted = g._paused = !1, g._totalTime = g._time = 0, g._rawPrevTime = -1, g._next = g._last = g._onUpdate = g._timeline = g.timeline = null, g._paused = !1;
		var D = function() {
		...
		D(), g.play = function( a, b ) {
			...
			if ( "on" === ( a || "" )
				...
				null == b ? delete e[ a ] : ( e[ a ] = b, e[ a + "Params" ] = o( c ) && -1 !== c.join( "" )
		...
		( g = E.prototype = new C )
		.constructor = E, g.kill()
			._gc = !1, g._first = g._last = g._recent = null, g._sortChildren = !1, g.add = g.insert = function( a, b, c, d ) {
				var e, f;
		...
		( g = F.prototype = new C )
		.constructor = F, g.kill()
			._gc = !1, g.ratio = 0, g._firstPT = g._targets = g._overwrittenProps = g._startAt = null, g._notifyPluginsOfEnabled = g._lazy = !1, F.version = "1.19.0", F.defaultEase = g._ease = new u( null, null, 1, 1 ), F.defaultOverwrite = "auto", F.ticker = h, F.autoSleep = 120, F.lagSmoothing = function( a, b ) {
				h.lagSmoothing( a, b )
		...
		V._startTime = h.time, U._startTime = h.frame, V._active = U._active = !0, setTimeout( X, 1 ), C._updateRoot = F.render = function() {
			...
			if ( I.length && X(), V.render( ( h.time - V._startTime ) * V._timeScale, !1, !1 ), U.render( ( h.frame - U._startTime ) * U._timeScale, !1, !1 ), I.length && X(), h.frame >= W ) {
				for ( c in W = h.frame + ( parseInt( F.autoSleep, 10 ) || 120 ), Q ) {
					for ( a = ( b = Q[ c ].tweens )
						.length; --a > -1; ) b[ a ]._gc && b.splice( a, 1 );
		...
		g._init = function() {
			...
			for ( g in J[ b._gsTweenID ] && X(), this.vars.css || b.style && b !== a && b.nodeType && P.css && !1 !== this.vars.autoCSS && function( a, b ) {
				...
				else if ( P[ g ] && ( j = new P[ g ] )
				._onInitTween( b, this.vars[ g ], this, f ) ) {
				for ( this._firstPT = k = {
						_next: this._firstPT,
						t: j,
						p: "setRatio",
			...
			if ( a = "string" != typeof a ? a : F.selector( a ) || a, ( o( a ) || G( a ) ) && "number" != typeof a[ 0 ] ) {
				...
				for ( c = ( d = Y( a )
						.concat() )
					.length; --c > -1; )( d[ c ]._gc || b && !d[ c ].isActive() ) && d.splice( c, 1 );
			return d
		...
		if ( g = aa.prototype, aa.version = "1.19.0", aa.API = 2, g._firstPT = null, g._addTween = N, g.setRatio = L, g._kill = function( a ) {
				...
				for ( var b, c = this._firstPT; c; )( b = a[ this._propName ] || null != c.n && a[ c.n.split( this._propName + "_" )
					.join( "" ) ] ) && "function" == typeof b && ( 2 === c.f ? c.t._applyPT.m = b : c.m = b ), c = c._next
				...
				var b, c = a.propName,
					...
					g = s( "plugins." + c.charAt( 0 )
						.toUpperCase() + c.substr( 1 ) + "Plugin", ( function() {
...
.push( ( function() {
		...
		var f = {
			...
			w = function( e ) {
				...
				if ( !/^#|^rgb/.test( e ) ) {
					...
					r.style.color = e;
					var a = t.getComputedStyle( r, null )
						.color;
					return a = /rgb/.test( a ) ? a.replace( /[^\d,]/g, "" )
						.split( "," ) : [ 0, 0, 0 ], r.style.color = "", {
							r: parseInt( a[ 0 ] ),
							g: parseInt( a[ 1 ] ),
							b: parseInt( a[ 2 ] )
						}
			...
			B = 8 === ( !( !navigator || null === new RegExp( "MSIE ([0-9]{1,}[.0-9]{0,})" )
				.exec( navigator.userAgent ) ) && parseFloat( RegExp.$1 ) ),
			...
			at = function() {
				var e = {},
					n = function( t, e ) {
						if ( t ) {
							for ( var n = t.style.cssText.replace( /\s/g, "" )
									.split( ";" ), i = {}, s = 0, r = n.length; s < r; s++ )
	...
	function( t, e ) {
		...
		var e = "undefined" != typeof global ? global : window,
			...
			u = null !== new RegExp( "MSIE ([0-9]{1,}[.0-9]{0,})" )
			.exec( navigator.userAgent ) && parseFloat( RegExp.$1 ),
		...
		if ( !( u && u < 9 ) ) {
			var f = /(m[^(h|v|l)]*|[vhl][^(v|h|l|z)]*)/gim,
				...
				d = function( t ) {
					for ( var e, r, n = t.match( f ), a = n.length, i = 0, s = 0, o = 0; o < a; o++ ) n[ o ] = n[ o ], e = n[ o ][ 0 ], r = new RegExp( e + "[^\\d|\\-]*", "i" ), n[ o ] = n[ o ].replace( /(^|[^,])\s*-/g, "$1,-" )
						.replace( /(\s+\,|\s|\,)/g, "," )
						.replace( r, "" )
						.split( "," ), n[ o ][ 0 ] = parseFloat( n[ o ][ 0 ] ), n[ o ][ 1 ] = parseFloat( n[ o ][ 1 ] ), 0 === o ? ( i += n[ o ][ 0 ], s += n[ o ][ 1 ] ) : ( i = n[ o - 1 ][ 0 ], s = n[ o - 1 ][ 1 ], /l/i.test( e ) ? ( n[ o ][ 0 ] = "l" === e ? n[ o ][ 0 ] + i : n[ o ][ 0 ], n[ o ][ 1 ] = "l" === e ? n[ o ][ 1 ] + s : n[ o ][ 1 ] ) : /h/i.test( e ) ? ( n[ o ][ 0 ] = "h" === e ? n[ o ][ 0 ] + i : n[ o ][ 0 ], n[ o ][ 1 ] = s ) : /v/i.test( e ) && ( n[ o ][ 0 ] = i, n[ o ][ 1 ] = "v" === e ? n[ o ][ 0 ] + s : n[ o ][ 0 ] ) );
					return n
				},
				y = function( t ) {
					return t.split( /z/i )
				...
				M = function( t, e ) {
					...
					if ( this._isPolygon )
						if ( t = d( t ), e = d( e ), t.length !== e.length ) {
							( i = Math.max( t.length, e.length ) ) === e.length ? ( s = t, o = e ) : ( s = e, o = t ), s.length, u = ( l = b( "M" + s.join( "L" ) + "z" ) )
								.getTotalLength() / i;
							...
							for ( var n = [], a = [], i = t.getTotalLength(), s = e.getTotalLength(), h = 0, u = Math.max( i, s ) / r * r;
								( h += r ) < u; ) n.push( [ t.getPointAtLength( h )
								.x, t.getPointAtLength( h )
								.y
							] ), a.push( [ e.getPointAtLength( h )
								.x, e.getPointAtLength( h )
								.y
							] );
							return [ n, a ]
						}( t = b( t ), e = b( e ), this.options.morphPrecision ) )[ 0 ], i = ( n = a[ 1 ] )
						.length;
			...
			var x = function( t, e ) {
				...
				E = function( t, e ) {
					...
					return e instanceof Object ? e : ( "string" == typeof e ? ( e = e.split( /\,|\s/ ), r = /%/.test( e[ 0 ] ) ? x( e[ 0 ].trim(), o ) : parseFloat( e[ 0 ] ), n = /%/.test( e[ 1 ] ) ? x( e[ 1 ].trim(), o ) : parseFloat( e[ 1 ] ) ) : void 0 === e && ( i = parseFloat( s( t, "stroke-dashoffset" ) ), a = s( t, "stroke-dasharray" )
						.split( /\,/ ), r = 0 - i, n = parseFloat( a[ 0 ] ) + r || o ), {
						s: r,
						e: n,
						l: o
					} )
			...
			var I = function( t, e ) {
					return /[a-zA-Z]/.test( t ) && !/px/.test( t ) ? t.replace( /top|left/, 0 )
						.replace( /right|bottom/, 100 )
						.replace( /center|middle/, 50 ) : /%/.test( t ) ? e.x + parseFloat( t ) * e.width / 100 : parseFloat( t )
				},
				L = function( t ) {
					var e = t && /\)/.test( t ) ? t.substring( 0, t.length - 1 )
						.split( /\)\s|\)/ ) : "none",
						r = {};
			...
			return a.svgTransform = function( t, e ) {
				...
				if ( this.options.rpr ) {
					...
					var a = this.element.ownerSVGElement,
						i = a.createSVGTransformFromMatrix( a.createSVGMatrix()
							.translate( -t.origin[ 0 ], -t.origin[ 1 ] )
							.translate( "translate" in t ? t.translate[ 0 ] : 0, "translate" in t ? t.translate[ 1 ] : 0 )
							.rotate( t.rotate || 0 )
							.skewX( t.skewX || 0 )
							.skewY( t.skewY || 0 )
							.scale( t.scale || 1 )
...
var ScrollReveal = function() {
	...
	function l( e, t ) {
		...
		if ( n ) {
			...
			if ( !n.blocked.head && i === [].concat( o.head )
				.pop() && i >= [].concat( r.body )
				.shift() ) return g.call( this, n, i, -1, t ), c.call( this, e, {
				reveal: !0,
				pristine: t
			} );
			if ( !n.blocked.foot && i === [].concat( o.foot )
				.shift() && i <= [].concat( r.body )
				.pop() ) return g.call( this, n, i, 1, t ), c.call( this, e, {
				reveal: !0,
				pristine: t
			} )
		}
			...
			f( i.reduce( ( function( e, t ) {
				...
				return s.contains( t ) && ( null === ( o = function( t ) {
					...
					r.computed = o ? o.map( ( function( e ) {
						...
						} ) ) ? r.computed : o.concat( [ "visibility: visible" ] )
						.map( ( function( e ) {
							return e.trim()
						} ) )
						.join( "; " ) + ";";
					...
					if ( parseFloat( i.distance ) ) {
						...
						switch ( k[ 1 ] ) {
							...
							case "px":
								...
								break;
							case "%":
								O = "Y" === T ? e.node.getBoundingClientRect()
									.height * x / 100 : e.node.getBoundingClientRect()
									.width * x / 100;
								break;
							default:
				...
				( c.store.elements[ e.id ] = e )
				.node.setAttribute( "data-sr-id", e.id )
			} ) )
		} catch ( e ) {
...
! function( e, t ) {
	...
	var t = {
		...
		css: function( e, t ) {
			...
			if ( 1 === arguments.length ) {
				...
				if ( this[ 0 ] ) return B.getComputedStyle( this[ 0 ], null )
					.getPropertyValue( e )
			}
	...
	var e, a, i, X = {
			...
			getTranslate: function( e, t ) {
				...
				return B.WebKitCSSMatrix ? ( 6 < ( i = r.transform || r.webkitTransform )
						.split( "," )
						.length && ( i = i.split( ", " )
							.map( ( function( e ) {
								return e.replace( ",", "." )
							} ) )
							.join( ", " ) ), s = new B.WebKitCSSMatrix( "none" === i ? "" : i ) ) : a = ( s = r.MozTransform || r.OTransform || r.MsTransform || r.msTransform || r.transform || r.getPropertyValue( "transform" )
						.replace( "translate(", "matrix(1, 0, 0, 1," ) )
					.toString()
					.split( "," ), "x" === t && ( i = B.WebKitCSSMatrix ? s.m41 : 16 === a.length ? parseFloat( a[ 12 ] ) : parseFloat( a[ 4 ] ) ), "y" === t && ( i = B.WebKitCSSMatrix ? s.m42 : 16 === a.length ? parseFloat( a[ 13 ] ) : parseFloat( a[ 5 ] ) ), i || 0
			},
					...
					for ( var T, S = t.slidesPerColumn, C = x / S, M = C - ( t.slidesPerColumn * C - d ), z = 0; z < d; z += 1 ) {
						...
						if ( 1 < t.slidesPerColumn ) {
							...
							"column" === t.slidesPerColumnFill ? ( L = z - ( $ = Math.floor( z / S ) ) * S, ( M < $ || $ === M && L === S - 1 ) && S <= ( L += 1 ) && ( L = 0, $ += 1 ), P = $ + L * x / S, k.css( {
									...
									"-webkit-order": P,
									order: P
								} ) ) : $ = z - ( L = Math.floor( z / C ) ) * C, k.css( "margin-" + ( e.isHorizontal() ? "top" : "left" ), 0 !== L && t.spaceBetween && t.spaceBetween + "px" )
						...
						if ( "none" !== k.css( "display" ) ) {
							if ( "auto" === t.slidesPerView ) {
								...
								D && ( k[ 0 ].style.transform = "none" ), O && ( k[ 0 ].style.webkitTransform = "none" ), E = e.isHorizontal() ? k[ 0 ].getBoundingClientRect()
									.width + parseFloat( I.getPropertyValue( "margin-left" ) ) + parseFloat( I.getPropertyValue( "margin-right" ) ) : k[ 0 ].getBoundingClientRect()
									.height + parseFloat( I.getPropertyValue( "margin-top" ) ) + parseFloat( I.getPropertyValue( "margin-bottom" ) ), D && ( k[ 0 ].style.transform = D ), O && ( k[ 0 ].style.webkitTransform = O ), t.roundLengths && ( E = Math.floor( E ) )
				...
				if ( 0 !== i.length ) {
					...
					for ( var n = 0; n < i.length; n += 1 ) {
						...
						if ( a.watchSlidesVisibility ) {
							...
							( 0 <= d && d < t.size || 0 < p && p <= t.size || d <= 0 && p >= t.size ) && i.eq( n )
	...
	var w, b = {
							...
							if ( !l || !( n <= d || n >= B.screen.width - d ) ) {
								if ( X.extend( a, {
									...
									L( r.target )
										...
										.is( a.formElements ) && f.activeElement !== r.target && f.activeElement.blur(), p && t.allowTouchMove && r.preventDefault()
								}
								t.emit( "touchStart", r )
							}
						}
		...
		E = {
			...
			images: {
				loadImage: function( e, t, a, i, s, r ) {
					...
					e.complete && s ? o() : t ? ( ( n = new B.Image )
		...
		S = function( u ) {
			function h() {
				...
				1 === a.length && a[ 0 ].constructor && a[ 0 ].constructor === Object ? s = a[ 0 ] : ( t = ( e = a )[ 0 ], s = e[ 1 ] ), s || ( s = {} ), s = X.extend( {}, s ), t && !s.el && ( s.el = t ), u.call( this, s ), Object.keys( E )
					.forEach( ( function( t ) {
						Object.keys( E[ t ] )
							.forEach( ( function( e ) {
		...
		D = {
			update: function( e ) {
				...
				if ( e ) t.$wrapperEl.find( "." + t.params.slideClass )
					...
					for ( var T = o; T <= l; T += 1 )( T < g || b < T ) && t.$wrapperEl.find( "." + t.params.slideClass + '[data-swiper-slide-index="' + T + '"]' )
						.remove();
		...
		G = {
			...
			handle: function( e ) {
				...
				if ( i.invert && ( s = -s ), a.params.freeMode ) {
					...
					a.mousewheel.lastScrollTime = ( new B.Date )
						.getTime()
				}
		...
		F = {
			...
			setTransition: function( s ) {
				void 0 === s && ( s = this.params.speed ), this.$el.find( "[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y]" )
					.each( ( function( e, t ) {
						var a = L( t ),
		...
		U = {
			...
			getPathValues: function() {
				var e = B.location.pathname.slice( 1 )
					.split( "/" )
					.filter( ( function( e ) {
						return "" !== e
					} ) ),
		...
		_ = {
			onHashCange: function() {
				...
				t !== e.slides.eq( e.activeIndex )
					.attr( "data-hash" ) && e.slideTo( e.$wrapperEl.children( "." + e.params.slideClass + '[data-hash="' + t + '"]' )
						.index() )
			},
			setHash: function() {
				var e = this;
				if ( e.hashNavigation.initialized && e.params.hashNavigation.enabled )
					if ( e.params.hashNavigation.replaceState && B.history && B.history.replaceState ) B.history.replaceState( null, null, "#" + e.slides.eq( e.activeIndex )
						.attr( "data-hash" ) || "" );
					else {
			...
			init: function() {
				...
				if ( !( !e.params.hashNavigation.enabled || e.params.history && e.params.history.enabled ) ) {
					...
					e.params.hashNavigation.watchState && L( B )
						.on( "hashchange", e.hashNavigation.onHashCange )
				}
			},
			destroy: function() {
				this.params.hashNavigation.watchState && L( B )
...
function( e, t ) {
	"object" == typeof exports && "undefined" != typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define( t ) : ( ( e = e || self )
		.Vimeo = e.Vimeo || {}, e.Vimeo.Player = t() )
}( this, ( function() {
	"use strict";
	...
	function i( e, t ) {
		return 0 === e.indexOf( t.toLowerCase() ) ? e : "".concat( t.toLowerCase() )
			.concat( e.substr( 0, 1 )
				.toUpperCase() )
			.concat( e.substr( 1 ) )
	}
	...
	function w( e, t, n ) {
		if ( e.element.contentWindow && e.element.contentWindow.postMessage ) {
			...
			void 0 !== n && ( r.value = n );
			var o = parseFloat( navigator.userAgent.toLowerCase()
				.replace( /^.*msie (\d+).*$/, "$1" ) );
	...
	function b( n, r ) {
		var t, e = [];
		if ( ( r = g( r ) )
			.event ) "error" === r.event && c( n, r.data.method )
			.forEach( ( function( e ) {
		...
		Player = function() {
			...
			return e = Player, ( t = [ {
				...
				value: function( e, t ) {
					...
					0 === c( this, "event:".concat( e ) )
						.length && this.callMethod( "addEventListener", e )
						.catch( ( function() {} ) ), u( this, "event:".concat( e ), t )
				}
			}, {
				key: "off",
				value: function( e, t ) {
					...
					h( this, "event:".concat( e ), t ) && this.callMethod( "removeEventListener", e )
						.catch( ( function( e ) {} ) )
				}
			}, {
				key: "loadVideo",
...
function() {
	...
	function() {
		Calendly.initInlineWidgets = function() {
			...
			var e, t, n, i, o;
			for ( o = [], n = 0, i = ( t = document.querySelectorAll( ".calendly-inline-widget" ) )
				.length; i > n; n++ )( e = t[ n ] )
				.getAttribute( "data-processed" ) ? o.push( void 0 ) : ( e.setAttribute( "data-processed", !0 ), o.push( new Calendly.Iframe( e, !0, "Inline" ) ) );
			return o
	...
	function() {
		Calendly.Iframe = function() {
			...
			return e.prototype.isMobile = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test( navigator.userAgent ), e.prototype.build = function() {
				...
				return null != this.url ? this.url : this.url = this.parent.getAttribute( "data-url" )
					.split( "#" )[ 0 ]
			}, e.prototype.getDivider = function() {
				return -1 === this.getURL()
					.indexOf( "?" ) ? "?" : "&"
				...
				return ( e = document.createElement( "div" ) )
					.className = "spinner", e.appendChild( this.buildBounce( 1 ) ), e.appendChild( this.buildBounce( 2 ) ), e.appendChild( this.buildBounce( 3 ) ), e
			}, e.prototype.buildBounce = function( e ) {
				var t;
				return ( t = document.createElement( "div" ) )
					.className = "bounce" + e, t
			}, e
		}()
	}.call( this ),
	function() {
		Calendly.PopupWidget = function() {
			...
			return t.prototype.show = function() {
				...
				var e;
				return ( e = document.createElement( "div" ) )
					.className = "calendly-close-overlay", e.onclick = this.close, e
			}, t.prototype.buildPopup = function() {
				var e;
				return ( e = document.createElement( "div" ) )
					.className = "calendly-popup", e.appendChild( this.buildPopupContent() ), e.appendChild( this.buildCloseButton() ), e
			}, t.prototype.buildPopupContent = function() {
				var e;
				return ( e = document.createElement( "div" ) )
					.className = "calendly-popup-content", e.setAttribute( "data-url", this.url ), new Calendly.Iframe( e, !1, this.embedType ), e
			}, t.prototype.buildCloseButton = function() {
				var e;
				return ( e = document.createElement( "div" ) )
					.className = "calendly-popup-close", e.onclick = this.close, e
	...
	function() {
		Calendly.BadgeWidget = function() {
			...
			return e.prototype.destroy = function() {
				...
				var e;
				return ( e = document.createElement( "div" ) )
					.className = "calendly-badge-content", "#ffffff" === this.options.color && ( e.className += " white" ), e.onclick = this.options.onClick, e.innerHTML = this.options.text, e.style.background = this.options.color, this.options.branding && e.appendChild( this.buildBranding() ), e
			}, e.prototype.buildBranding = function() {
				var e;
				return ( e = document.createElement( "span" ) )
					.innerHTML = "powered by Calendly", e
			}, e
		}()
...
var consoleCss = "font-size: 13px; padding: 85px 50px 5px 0px; background: url(https://carlos-burelo.github.io/fav/web-icon.png) no-repeat; background-size: auto 50px; background-position: 0 15px";
console.log( "%cHello", consoleCss );
var navIsOpen = !1,
...
ScrollReveal()
	.reveal( ".container-animation div", {
		delay: 100,
		origin: "top",
		interval: 50,
		scale: 0,
...
window.onload = function() {
	...
	}, null !== document.querySelector( ".globe__website__image" ) && ScrollReveal()
	.reveal( ".globe__website__image", {
		duration: 500,
		delay: 200,
		interval: 200,
		reset: !1,
		...
		scale: .5
	}, 200 ), null !== document.querySelector( ".globe__website__image" ) && ScrollReveal()
	.reveal( ".globe__website__image", {
		duration: 500,
		delay: 50,
		interval: 50,
		...
		easing: "cubic-bezier(0.6, 1.49, 0.39, 0.99)",
		scale: .25
	}, 500 ), null !== document.querySelector( ".how__animation__icon__image" ) && ScrollReveal()
	.reveal( ".how__animation__icon__image", {
		duration: 500,
		delay: 100,
		interval: 100,
		reset: !1,
...
var getOffsetTop = function( elem ) {
	...
	caseParallax = function( elem, speed, direction ) {
		for ( var scrolled = window.pageYOffset, windowHeight = window.innerHeight, i = 0; i < elem.length; i++ ) {
			var cardHeight = elem[ i ].parentNode.getBoundingClientRect()
				.height,
